                ...
                {isLoggedIn && user ? (
                  <>
                    ...
                    <Link
                      ...
                      className="flex items-center gap-2 px-4 py-2 text-xs font-medium text-gray-700 hover:bg-red-50 hover:text-[#d43533]"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 w-full px-4 py-2 text-left text-xs font-semibold text-red-600 hover:bg-red-50"
                    >
